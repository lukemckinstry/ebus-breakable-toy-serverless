...
class RouteSerializer(serializers.ModelSerializer):
    ...
    agency_name = serializers.CharField(read_only=False, source="agency_id.agency_name")
    agency_id = serializers.CharField(read_only=False, source="agency_id.agency_id")

    class Meta:
        model = Route 

        fields = ['route_id', 'agency_name', 'agency_id','route_short_name', 'route_long_name',
    ...
    def create(self, validated_data):
        ...
        agency = Agency(id=agency_id['agency_id'])
